...
for i in range(1,36):
    left = Image.open("{}{}/{}_{}/{}_{}_IMG_REC_CV_left.bmp".format(BASE_PATH,PACKAGE,PACKAGE,i,PACKAGE,i))
    right = Image.open("{}{}/{}_{}/{}_{}_IMG_REC_CV_right.bmp".format(BASE_PATH,PACKAGE,PACKAGE,i,PACKAGE,i))

    #left = ImageOps.autocontrast(left)
    #right = ImageOps.autocontrast(right)

    left_mask = Image.open("{}{}/{}_{}/{}_{}_MASK_REC_CV_left.png".format(BASE_PATH,PACKAGE,PACKAGE,i,PACKAGE,i))
    right_mask = Image.open("{}{}/{}_{}/{}_{}_MASK_REC_CV_right.png".format(BASE_PATH,PACKAGE,PACKAGE,i,PACKAGE,i))
...
#    mask_image(right,right_mask)
    ...
    for y in range(disp.shape[0]):
        for x in range(disp.shape[1]):
            ...
            if eval_mask.getpixel((x,y)) != (0,0,0) or dist > 1.1 or is_spec:
