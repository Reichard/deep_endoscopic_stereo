...
bool EndoCheck::Run()
{
    ...
    sprintf(left, "%sscene_left0001670.bmp", m_path);
    sprintf(right, "%sscene_right0001670.bmp", m_path);
...
*/
            ...
            {
                char file[200];
                sprintf(file, "/local_home/daniel/sparse_pig/for_video2/left_depth_%i.disp", frameNumber);
                ...
                sprintf(file, "/local_home/daniel/sparse_pig/for_video2/left_normal_%i.png", frameNumber);
                //inImages[0]->SaveToFile(file);
                imwrite(file, out_left);
                sprintf(file, "/local_home/daniel/sparse_pig/for_video2/right_normal_%i.png", frameNumber);
                //inImages[0]->SaveToFile(file);
