...
def load_batches(base_path):
    ...
    B = batchsize
    batches = [make_batch(left_images[i:i+B],right_images[i:i+B],disp_images[i:i+B],1) for i in range(0,len(left_images),B)]
...
def main():
    ...
    for epoch in range(start_epoch, epoch_count):
        ...
        debug_image.save(('out/debug_endo/{}.png').format(epoch))
        ...
        debug_image.save(('out/debug_endo_val/{}.png').format(epoch))
